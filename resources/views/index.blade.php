...
@section('content')
    ...
    <div class="card card-animate">
        ...
        <span>{{ \App\Models\Document::count() }}</span>
    </h4>

                    <a href="{{ route('documents.index') }}" class="text-decoration-underline">
                        View all documents
                    </a>
                </div>
    ...
    <div class="card card-animate">
        ...
        <span>{{ \App\Models\User::count() }}</span>
                    ...
                    <a href="{{ route('users.index') }}" class="text-decoration-underline">
                        View all users
                    </a>
                </div>
