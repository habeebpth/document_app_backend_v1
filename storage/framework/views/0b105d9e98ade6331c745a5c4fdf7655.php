...
<div class="mb-3">
    ...
    <input type="hidden" name="tags" id="tags_input" value="<?php echo e(json_encode($selectedTags)); ?>">
</div>
...
$(function () {
    ...
    let table = $('#documents-table').DataTable({
        ...
        serverSide: true,
        responsive: true,
        ajax: "<?php echo e(route('documents.index')); ?>",
        columns: [
    ...
    $('#documentForm').submit(function (e) {
        ...
        let url = id ? `/documents/${id}` : "<?php echo e(route('documents.store')); ?>";
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\bexone\resources\views/documents/index.blade.php ENDPATH**/ ?>