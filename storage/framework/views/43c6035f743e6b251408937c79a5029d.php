...
<div class="app-menu navbar-menu">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(url('index')); ?>" role="button"
    ...
    <a class="nav-link menu-link
        <?php if(request()->routeIs('categories.*') || request()->routeIs('tags.*')): ?>
            active
        <?php endif; ?>"
        href="#sidebarMasters"
        ...
        role="button"
        aria-expanded="
            <?php echo e(request()->routeIs('categories.*') || request()->routeIs('tags.*')  ? 'true' : 'false'); ?>"
        ...
        <ul class="nav nav-sm flex-column">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('tags.index')); ?>"
                   class="nav-link <?php echo e(request()->routeIs('tags.*') ? 'active' : ''); ?>">
                    Tags
                </a>
            </li>
...
<?php /**PATH C:\Users\USER\Desktop\bexone\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>