...
<div class="auth-page-wrapper pt-5">
 ...
 <div class="auth-one-bg-position auth-one-bg"
     id="auth-particles"
     style="background-image: url('<?php echo e(!empty($setting->background_image) ? asset('storage/settings/' . basename($setting->background_image)) : asset('build/icons/auth-one-bg.jpg')); ?>');
                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                  <!-- <img src="<?php echo e(asset('storage/settings/' . basename($setting->background_image))); ?>" alt="Background Image" height="20"> -->
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to  <?php echo e($setting->company_name ?? ''); ?></p>
                            </div>
                            <div class="p-2 mt-4">
...
<p class="mb-0 text-muted">
    ...
    .  with <i class="mdi mdi-heart text-danger"></i> by Cloudocz
</p>                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\bexone\resources\views/auth/login.blade.php ENDPATH**/ ?>