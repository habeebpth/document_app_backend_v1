...
<img class="rounded-circle header-profile-user"
     src="<?php echo e(optional($setting)->company_logo 
            ? asset('storage/settings/' . basename($setting->company_logo)) 
            : asset('build/icons/default-logo.png')); ?>"
     alt="Company Logo">
        ...
        <!-- <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">Founder</span> -->
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome <?php echo e($setting->company_name ?? ''); ?>!</h6>
...
<?php /**PATH C:\Users\USER\Desktop\bexone\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>