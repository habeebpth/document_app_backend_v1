...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-animate">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                    <h5 class="text-success fs-14 mb-0">
                        <i class="ri-file-2-line fs-13 align-middle"></i>
                    </h5>
                </div>
            </div>
        ...
        <span><?php echo e(\App\Models\Document::count()); ?></span>
    </h4>

                    <a href="<?php echo e(route('documents.index')); ?>" class="text-decoration-underline">
                        View all documents
                    </a>
                </div>
    ...
    <div class="card card-animate">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                    <h5 class="text-success fs-14 mb-0">
                        <i class="ri-group-line fs-13 align-middle"></i>
                    </h5>
                </div>
            </div>
            ...
            <div class="d-flex align-items-end justify-content-between mt-4">
                <div>
                    <h4 class="fs-22 fw-semibold ff-secondary mb-4">
        <span><?php echo e(\App\Models\User::count()); ?></span>
    </h4>

                    <a href="<?php echo e(route('users.index')); ?>" class="text-decoration-underline">
                        View all users
                    </a>
                </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Desktop\bexone\resources\views/index.blade.php ENDPATH**/ ?>